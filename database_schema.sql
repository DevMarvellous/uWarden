...
DROP POLICY IF EXISTS "Users can insert their own blacklist" ON blacklists;
DROP POLICY IF EXISTS "Users can update their own blacklist" ON blacklists;
DROP POLICY IF EXISTS "Users can delete their own blacklist" ON blacklists;
